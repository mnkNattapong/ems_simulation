function sol = EMS1_opt(PARAM,is_save,save_path) 
    ...
    u =         optimvar('u',length_optimvar,'LowerBound',0,'UpperBound',inf);    % Upper bound of Expense
    ...
    if is_save == 1
        ...
        save(strcat(save_path,'/EMS1/',PARAM.TOU_CHOICE,'_',num2str(PARAM.Resolution),'min_',PARAM.start_date,'.mat'),'-struct','sol')
    end
end